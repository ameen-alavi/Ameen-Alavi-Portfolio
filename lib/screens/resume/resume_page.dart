            ...
            child: Column(
              ...
              children: [
                ...
                ResumeActionButton(
                  ...
                  onPressed: () async {
                    if (kIsWeb) {
                      openPdfInNewTab('assets/assets/Ameen_Alavi_Resume.pdf');
                    } else {
                      final url =
                          'https://ameen-alavi.github.io/Ameen-Alavi-Portfolio/assets/assets/Ameen_Alavi_Resume.pdf';
                ...
                ResumeActionButton(
                  ...
                  onPressed: () async {
                    if (kIsWeb) {
                      downloadPdf(
                        'assets/assets/Ameen_Alavi_Resume.pdf',
                        'Ameen_Alavi_Resume.pdf',
                      );
                    } else {
                      final url =
                          'https://ameen-alavi.github.io/Ameen-Alavi-Portfolio/assets/assets/Ameen_Alavi_Resume.pdf';
